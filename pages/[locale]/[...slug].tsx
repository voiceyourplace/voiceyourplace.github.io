...
const pageComponentMap: Record<PageSlug, any> = {
  ...
  'palatul-comisiei-europene': dynamic(() => import('../landmark')),
  'farul-comisiei-europene': dynamic(() => import('../landmark')),
  'bisericile-orasului-sulina': dynamic(() => import('../landmark')),
  'uzina-de-apa': dynamic(() => import('../landmark')),
  'cimitirul-multietnic': dynamic(() => import('../landmark')),
  'pasarile-deltei': dynamic(() => import('../landmark')),
  ...
  'audio-guide-sulina': dynamic(() => import('../audio-guide-sulina')),
  project: dynamic(() => import('../project')),
  'project-slatina': dynamic(() => import('../project-slatina')),
  'project-sulina': dynamic(() => import('../project-sulina')),
